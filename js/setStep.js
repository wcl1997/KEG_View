...
SetStep.prototype.init=function(arg){
    ...
    var stepDisc = "<li class='ystep-step ystep-step-undone'><span></span></li>";
    var stepP=$("<div class='ystep-progress' style='width: 200px;'>"+
                "<p class='ystep-progress-bar' style='width: 200px;'><span class='ystep-progress-highlight' style='width:0%'></span></p>"+
            "</div>");
    ...
    stepsHtml.find('li').css('width','110px').css('marginRight','0px')
	...
	this.setProgress(this.stepContainer,2,this.opt.stepCounts)
    //判断参数 是否显示按钮 并绑定点击事件
    if(this.opt.showBtn){
